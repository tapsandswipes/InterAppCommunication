...
// File Name   : GamePlayViewController.h
// Description : Header file of "GamePlayViewController.m"
...
@interface GamePlayViewController : UIViewController {	
    ...
    GameData *gamePlayGameData;
}

@property (nonatomic, assign) MainViewController *mainViewController;
@property (nonatomic, retain) GameData *gamePlayGameData;
-(void) initializeGame;
@end
