...
// File Name   : EndingViewController.h
// Description : Header file of "EndingViewController.m"
...
@interface EndingViewController : UIViewController {
    ...
    GameData *endingGameData;
}
@property (nonatomic, assign) MainViewController *mainViewController;
@property (nonatomic, retain) GameData *endingGameData;
-(void) refreshDisplay;
@end
