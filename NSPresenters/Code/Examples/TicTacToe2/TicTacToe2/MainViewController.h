...
// Description : Header file of "MainViewController.m"
...
@class EndingViewController;

@interface MainViewController : UIViewController {
    EndingViewController *controllerEnding;
    GamePlayViewController *controllerGamePlay;
    IntroductionViewController *controllerIntro;
    GameData *currentGameData;
}

@property (nonatomic, retain) GameData *currentGameData;
